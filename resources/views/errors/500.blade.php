    ...
    <div class="row">
        <div class="m-auto col-md-8">
            <div class="about_title text-center">
                <h1 class="text-danger" style="font-size: 180px;"><strong>500</strong></h1>
                <h2 style="font-size: 30px;" class="mb-0">Internal Server Error</h2>
                <p class="text-muted"><span class="fa fa-info-circle"></span>A generic error message, given when no more specific message is suitable.</p>
