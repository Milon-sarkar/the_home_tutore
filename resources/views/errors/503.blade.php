    ...
    <div class="row">
        <div class="m-auto col-md-8">
            <div class="about_title text-center">
                <h1 class="text-danger" style="font-size: 180px;"><strong>503</strong></h1>
                <h2 style="font-size: 30px;" class="mb-0">Service Unavailable</h2>

                <p class="text-muted"><span class="fa fa-info-circle"></span>The server is currently unavailable (overloaded or down) </p>
            </div>
