                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="action_btn text-center">
                                ...
                                <input type="button" class="btn-info btn-lg" value="Apply Now" data-toggle="modal" data-target="#applyModalCenter" style="background-color: #e2136e">
                                @else
                                <code class="text-left">Your Account is not active. Contact the admin to activate.</code>
                                @endif
                                @else
                                ...
                                #
                                @endif
                                {{-- If it is a tutor end --}}
                                @else
                                @if ($tuition->is_blocked_application != 'lock')
                                @if (auth()->id() != $tuition->user_id)
                                <input type="button" class="but btn-info btn-lg" value="Apply Now" data-toggle="modal" data-target="#applyModalCenter" style="background-color: #e2136e; border:1px solid #e2136e;">
                                @else
                                <a href="#" class="not_available_btn">Not Available</a>
                                @endif
                                @endif
                ...
                <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <div class="row">
                                <div class="col-12">
                                    <p> ★★★শুধু মাত্র বুয়েট টিউটরদের জন্য টিউশন ম্যাচিং ফি ১ম মাসের সেলারির ৫০%।
                                    </p>
                                    <p> ★★★ গার্ডিয়ান টিউশন কনফার্ম করলে ১৫ দিনের মধ্যে সম্পূর্ণ ম্যাচিং ফি পরিশোধ করতে হবে। নির্ধারিত সময়ে মিডিয়া ফি পরিশোধ না করলে টিউশনটি ক্যান্সেল করা হবে।</p>
                                    <p>★★★আপনি যদি শতভাগ দায়িত্বশীল হন তাহলেই কেবল এপ্লাই করুন। ব্যক্তিগত কারণ দেখিয়ে টিউশন বাদ দিলে এর দায়ভার সম্পূর্ণ আপনার। </p>
                                    <p>★★★ এজন্য টিউশন লোকেশন ও টিউশন রিকয়ারমেন্ট দেখে আবেদন করুন। </p>
                                    <p>★★★তবে কিছু শর্তসাপেক্ষে ম্যাচিং ফি কমানোর সুযোগ রয়েছে। ম্যাচিং ফি কমাতে চাইলে নোটে উল্লেখ করুন। বিশেষ দ্রষ্টব্যঃ- আপনি এই টিউশনে গার্ডিয়ান কর্তৃক নির্বাচিত হলে আগামী ২৪ ঘণ্টার ভিতর আপনার সাথে যোগাযোগ করা হবে। ধন্যবাদ </p>
                                </div>
                                <div class="col-12">
                                    <label for="tutor_urgency" class="text-start">Write down your <span class="text-danger">urgency, experience, qualification</span> for this tuition <sup class="text-danger">*</sup></label>
                                    <textarea name="tutor_urgency" id="tutor_urgency" maxlength="500" form="tuition_book_apply" required class="form-control" style="height: 150px;"></textarea>
                                </div>
                                <div class="col-12">
                                    <p>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn  btn-lg btn-secondary" data-dismiss="modal">Close</button> {{-- <button type="button" class="btn  btn-lg btn-secondary" data-dismiss="modal">Close</button> --}}
                            <form action="{{ route('tution_book_apply') }}" method="POST" id="tuition_book_apply">
                                ...
                                @if(auth()->id() != $tuition->user_id)
                                <div>
                                    <input type="submit" class="book_btn btn btn-lg btn-info" value="Apply Now" style="background-color: #e2136e;
