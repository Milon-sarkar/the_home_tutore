...
<ul class="list-unstyled list-inline second_nav">
    <li class="mb-1 {{ menu_active('complete_profile') && request()->get('type') == 'academic_information' ? 'active_sub' : '' }}"><a href="{{ route('complete_profile') }}?type=academic_information">Academic Information</a></li>
{{--    <li class="mb-1 {{ menu_active('profile') && request()->get('type') == 'academic_qualification' ? 'active_sub' : '' }}"><a href="{{ route('profile') }}?type=academic_qualification">Academic Qualification</a></li>--}}
    <li class="mb-1 {{ menu_active('complete_profile') && request()->get('type') == 'personal_information' ? 'active_sub' : '' }}"><a href="{{ route('complete_profile') }}?type=personal_information">Personal Information</a></li>
