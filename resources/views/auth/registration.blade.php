            ...
            <div class="col-md-6">
                ...
                <div class="input_area">
                    ...
                    <ul class="nav nav-pills nav-fill">
                        <li class="nav-item">
                            <a class="nav-link {{ $register_type == 'tutor' ? 'active' : '' }} " href="?register_type=tutor">Register As Tutor</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $register_type == 'guardian' ? 'active' : '' }}" href="?register_type=guardian">Register As Guardian</a>
                        </li>
                    </ul>

                    <div class="field_area mt-5">
                        <form method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="name" class="form-label">Full Name <sup class="text-danger">*</sup>
                                </label>
                                <input type="name" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" placeholder="Enter Your Name" autocomplete="name" autofocus required>
                                <input type="hidden" class="form-control" id="user_type" aria-describedby="user_type" value="tutor" name="user_type">
                                @error('name')
                            ...
                            {{-- </div> --}}
                            <div class="mb-3">
                                <label for="phone_number" class="form-label">Phone <sup class="text-danger">*</sup>
                                </label>
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone_number" value="{{ old('phone') }}" placeholder="Enter Your phone" aria-describedby="phoneHelp" required onkeyup="phone_input()">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" placeholder="Enter Your email" aria-describedby="emailHelp" required>
                            ...
                            {{-- <div class="mb-3">
                                    <label for="password" class="form-label">Password <sup class="text-danger">*</sup>
                                    </label>
                                    <input type="text" class="form-control @error('password') is-invalid @enderror"
                                        name="password" id="password" value="{{ old('password') }}"
                            placeholder="Enter Your password" aria-describedby="passwordHelp" required
                            onkeyup="password_input()">
                            <small><strong class="text-danger" id="password_msg"></strong></small>
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" name="password_confirmation" class="form-control" id="password-confirm" required placeholder="*********">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="my-3" style="@if ($register_type == 'tutor') display: none; @elseif($register_type == 'guardian') display: none; @elseif($register_type == 'student') display: none; @endif">
                        <label for="user_type" class="form-label">Register as <sup class="text-danger">*</sup>
                        </label>
                        <select name="user_type" id="user_type" required class="form-control">
                            ...
                            <option value="student" id="student" {{ $register_type == 'student' ? 'selected' : '' }}>I need tutor for myself
                            </option>
                        </select>
                    </div>
                    ...
                    <div id="tutor_form" @if (count($errors)> 0 and old('user_type') == 'tutor') style="display: inline" @endif
                        @if ($register_type != 'tutor') style="display: none"
                        ...
                        <div class="row">
                            ...
                            {{-- </div> --}}
                            <div class="col-md-6">
                                <label for="whatsapp" class="form-label" style="margin-top: 10px">Whatsapp <sup class="text-danger">*</sup> </label>
                                <input type="text" class="form-control @error('whatsapp') is-invalid @enderror" name="whatsapp" id="whatsapp" value="{{ old('whatsapp') }}" @if ($register_type=='tutor' ) required @endif aria-describedby="whatsappHelp">
                                @error('whatsapp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-6">
                                <label for="gender" class="form-label" style="margin-top: 10px">Gender <sup class="text-danger">*</sup></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group pt-2">
                                    ...
                                    <select name="interest_class[]" id="interest_class" class=" js-example-basic-single form-control" multiple="multiple" @if ($register_type=='tutor' ) required @endif>
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="interest_sub[]" id="interest_sub" class="form-control js-example-basic-single" multiple="multiple" @if ($register_type=='tutor' ) required @endif>
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="interest_medium[]" id="interest_medium" class="form-control select2 js-example-basic-single" multiple="multiple" @if ($register_type=='tutor' ) required @endif>
                            ...
                            <div class="col-md-12">
                                <label for="preferred_area_id" class="form-label">
                                    ...
                                    <small class="d-block text-muted"><strong>Note: </strong><i>If you don't
                                            find your option, <code>write your location name</code> and press
                                            <code>,</code></i></small>
                                </label>
                                <!-- <select name="preferred_area_id[]" id="preferred_area_id"
                                                class="js-example-basic-single select2 form-control" multiple="multiple"
                                                @if ($register_type == 'tutor') required @endif>
                                                @foreach (\App\Models\Area::orderBy('name', 'ASC')->get() as $area)
                                                    <option value="{{ $area->id }}">{{ $area->name }}</option>
                                                @endforeach
                                            </select> -->
                                <select name="preferred_area_id[]" id="preferred_area_id" class="form-control select2 js-example-basic-single" multiple="multiple" @if ($register_type=='tutor' ) required @endif>
