...
@section('content')
    <form action="{{ route('tuition_comment.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        @if($tuition)
        <input type="hidden" name="tuition_id" value="{{ $tuition->id }}" readonly>
        @endif
        <div class="row">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tuition_id" id="" class="form-control select2">
                                @foreach($tuitions as $tuition)
                                    <option value="{{ $tuition->id }}">{{ $tuition->job_id }}</option>
                                @endforeach
                            </select>
                            @error('tuition_id')
                                <small class="text-danger">{{ $message }}</small>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="body" id="" cols="30" class="w-100">{{ old('body') }}</textarea>
                            @error('body')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
