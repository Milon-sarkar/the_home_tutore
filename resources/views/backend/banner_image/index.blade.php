        ...
        <div class="col-md-8">
            <div class="card-box">
                ...
                <table class="table table-bordered text-center">
                    ...
                    @forelse($banners as $title_template)
                    <tr>
                        {{-- <td>{{ $loop->index + 1 }}</td> --}}
                        <td>
                        ...
                        <td class="d-flex justify-content-around">
                            ...
                            <div class="modal text-left fade" id="edit_{{ $title_template->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('banner_image.update', $title_template->id) }}" method="POST" enctype="multipart/form-data">
                                            @method("PUT")
                                            @csrf
                            ...
                            <form action="{{ route('banner_image.destroy', $title_template->id) }}" method="POST">
                                @csrf
                                @method("DELETE")
